...
<div class="container mb-4">
  ...
  { 
    if($count == 0 || $count % 3 == 0) {  ?> <div class="row"> <?php } // open row div at start/every 3 items?> 
      <div class="col-md-4 mb-4 d-flex align-items-stretch">
        ...
        <div class="card mb-6" >
          ...
          <div class="card-body">
            ...
            <button type='button' class='btn btn-primary' data-mdb-toggle='modal' data-mdb-target='#editPostModal<?php echo $categories['id'];?>'>Edit post</button>
      ...
      <div class="modal fade " id="editPostModal<?php echo $categories['id'];?>" aria-labelledby="editPostModalLabel" aria-hidden="true">
          ...
          <div class="modal-content bg-primary">
            ...
            <div class="modal-body">
                  <div class="text-center">
                    <label for='postImage' class='fw-bold text-primary text-decoration-underline'>Image</label>
                  <img style="height:40vh;" class='img-thumbnail rounded mx-auto d-block img-fluid' id='postImage' src='<?php echo $categories['image_path']; ?>'>
                  <input type='file' class='form-control-file custom-file-input' name='file<?php echo $categories["id"];?>' accept='image/*' onchange='previewImage(event)'>
                  </div>
                    <input id= 'postId<?php echo $categories["id"];?>' type= 'hidden' value= '<?php echo $categories["id"];?>'></input>


                  <div class='form-group p-2'>
                    <label for='title' class='fw-bold'>Title</label>
                    <input type='text' class='form-control' name='title<?php echo $categories["id"];?>' value="<?php echo $categories["title"]?>" required> </div>
                  ...
                  <label for='text' class='fw-bold'>Text</label>
                    <textarea id='editor<?php echo $categories['id'];?>' name='text'><?php echo $categories['description'] ?></textarea>
                  </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-mdb-dismiss="modal">Close</button>
              <button type="button" class="btn btn-success drawModal<?php echo $categories["id"];?>">Save changes</button>
            </div>
          </div>
        </div>
      </div> 
    ...
    <script>
    var editor = $('#editor<?php echo $categories['id'];?>').trumbowyg();

    document.querySelector('.drawModal<?php echo $categories['id'];?>').addEventListener('click', function() {
      
        var postId = document.getElementById('postId<?php echo $categories["id"];?>').value;
        var title = document.querySelector("input[name='title<?php echo $categories["id"];?>']").value;
